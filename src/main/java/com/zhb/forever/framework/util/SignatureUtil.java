...
*@createDate 2018年10月31日上午9:31:09
*/
...
public class SignatureUtil {
    ...
    public String generateSignature(String appid, String token, String lol, long millis) {
        ...
        if (StringUtil.isNotBlank(token) && StringUtil.isNotBlank(timestamp) && StringUtil.isNotBlank(appid)) {
    ...
    public boolean isValid(String signature, String appid, String lol, long millis) {
        ...
        if (StringUtil.equals(calculatedSignature, signature)) {
            return true;
        } else {
            return false;
        }
